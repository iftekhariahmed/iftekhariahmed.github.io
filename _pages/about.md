...
Welcome to my website. I am a final year Ph.D. candidate in Finance **(Climate Finance)** at the [Climate and Energy Finance Group (CEFGroup)](https://blogs.otago.ac.nz/cefg/), **Otago Business School, University of Otago**. I am interested in how climate extreme poses financial risk and distress on **Firms, Financial Markets and Institutions** as well as the role of **Public Policy**, and **Climate-aligned Finance and Investment** for the **Net-Zero Transition**. I am passionate about using innovative and sophisticated economic modelling and quantitative analysis to support high-quality, evidence-based policy advice.
